...
Product Landing Page WordPress Theme, Copyright 2022 ThemeEverest
Product Landing Page is distributed under the terms of the GNU GPL
All files coded by me, and fonts (for example Product Landing Page font) is under GPLv2 http://www.gnu.org/licenses/gpl-2.0.html

Product Landing Page bundles the following third-party resources:
...
View image » https://pixabay.com/en/urban-people-crowd-citizens-438393/
_______
IMG FROM SCREENSHOT
CC0 License
✓ Free for personal and commercial use
✓ No attribution required
View image » https://pixabay.com/en/landscape-mountains-hills-forest-336542/
_______
IMG FROM SCREENSHOT
CC0 License
✓ Free for personal and commercial use
✓ No attribution required
View image » https://www.pexels.com/photo/landscape-sun-trees-path-21008/
_______
IMG FROM SCREENSHOT
CC0 License
✓ Free for personal and commercial use
✓ No attribution required
View image » https://www.pexels.com/photo/woman-stands-on-mountain-over-field-under-cloudy-sky-at-sunrise-847483/
_______
IMG FROM SCREENSHOT
CC0 License
✓ Free for personal and commercial use
...
✓ Free for personal and commercial use
✓ No attribution required
Learn more about the license » https://www.pexels.com/photo/light-road-landscape-nature-35600/
_______
IMG FROM SCREENSHOT
CC0 License
✓ Free for personal and commercial use
✓ No attribution required
Learn more about the license » https://www.pexels.com/photo/asphalt-dark-dawn-endless-531321/
_______


- Mihis Alex - CC0 License ✓ Free for personal and commercial use ✓ No attribution required
	https://www.pexels.com/photo/landscape-sun-trees-path-21008/
	

--- TGM ---
- package: TGM-Plugin-Activation
- subpackage: Example
- version: 2.6.1 for parent theme Product Landing Page for publication on WordPress.org
- author: Thomas Griffin, Gary Jones, Juliette Reinders Folmer
- copyright: Copyright (c) 2011, Thomas Griffin
- license: http://opensource.org/licenses/gpl-2.0.php GPL v2 or later
- link: https://github.com/TGMPA/TGM-Plugin-Activation

* Jetpack by Automaticc is integrated: https://wordpress.org/plugins/jetpack/ it's GPL v2
...
* Based on personalblogily https://wordpress.org/themes/personalblogily/
	* (C) ThemeEverest, Inc., [GPLv2 or later](https://www.gnu.org/licenses/gpl-2.0.html)
* I have forked the "related posts" code which can be found in single.php from MyThemeShop's theme called "Point" which is licensed under GPL V2: https://wordpress.org/themes/point/

* Beaver page builder is integrated in the theme: https://wordpress.org/plugins/beaver-builder-lite-version/ and recommended by TGMPA. TGMPA license: http://opensource.org/licenses/gpl-2.0.php GPL v2 or later - TGMPA link: https://github.com/TGMPA/TGM-Plugin-Activation
...
* Graphics in Screenshot (such as the three boxes with page speedscores in and the graph underneath) is made by us and is licensed under GPL, use them for whatever you want

* Jquery is integrated in the theme and used https://jquery.org/license/ which is MIT licensed
...
* Screenshot icons and images in /icons are GPLv2 as well are GPLv2 as well made in Adobe Illustrator 6 by us
...
- MIT license: https://en.wikipedia.org/wiki/MIT_License
- https://owlcarousel2.github.io/OwlCarousel2/docs/started-faq.html
